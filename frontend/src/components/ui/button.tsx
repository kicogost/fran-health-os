...
// Pill-shaped (2026-08-30, Spotify's "pill everything" button vocabulary --
// primary/text CTAs as a full pill, icon-only buttons as a perfect circle
// since size and width are equal). Was rounded-lg; every real usage in this
// app is the default variant/size (the Log page's 4 form submit buttons),
// so this is a real, visible change, not a dead-code no-op.
